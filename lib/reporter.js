...
class AllureReporter extends events.EventEmitter {
    ...
    addResults (test) {
        if (test.cid && this.startedSpecs) {
            ...
            currentTest.addParameter('environment-variable', 'TESTCASE RESULTS: ', tcResultsStr)
            currentTest.addParameter('environment-variable', 'SPEC RESULTS: ', specResultsStr)
        }
    }
