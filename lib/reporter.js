        ...
        */
        ...
        this.on('step:end', function (step) {
            ...
            if (step.assertionFailures) {
                this.dumpJSON(allure, 'Validation Failures', step.assertionFailures)
            }

            if (step.screenshots) {
                for (const screenshotMessage in step.screenshots) {
                    for (let i = 0; i < step.screenshots[screenshotMessage].length; ++i) {
                        if (step.screenshots[screenshotMessage] && step.screenshots[screenshotMessage][i]) {
        ...
        this.on('step:fail', function (step) {
            ...
            this.dumpJSON(allure, 'Validation Failures', step.errs)
