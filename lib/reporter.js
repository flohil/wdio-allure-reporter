    ...
    constructor (baseReporter, config, options = {}) {
        ...
        this.dumpFailuresAndErrors = function (allure, _assertions) {
            ...
            _assertions.forEach(assertion => {
                const newAssertion = Object.assign(assertion)

                if (newAssertion.stack.trim().indexOf('at') === 0) {
                    newAssertion.stack = newAssertion.message + '\n' + newAssertion.stack
                }

                assertions[newAssertion.stack] = newAssertion
            })
